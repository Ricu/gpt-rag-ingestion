...
class MultimodalChunker(DocAnalysisChunker):
    ...
    def __init__(self, data, max_chunk_size=None, minimum_chunk_size=None, token_overlap=None):
        ...
        self.image_container = os.environ.get("DOCUMENTS_IMAGES_STORAGE_CONTAINER", "documents-images")
        self.storage_account_name = os.environ.get("STORAGE_ACCOUNT_NAME", "set-storage-account-name-env-var")
        self.minimum_figure_area_percentage = float(os.environ.get("MINIMUM_FIGURE_AREA_PERCENTAGE", "4.0"))
